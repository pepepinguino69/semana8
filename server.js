...
app.get('/pug',async (req, res) => await myInstance.getById(-1).then((data)=>res.render('index2',{id:data.id,price:data.price,title:data.title})))
...
app.get("/card", (req, res) => res.sendFile(__dirname + '/views/card.html'))
