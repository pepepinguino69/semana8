...
app.get('/json/productos', (req, res) => myInstance.getAll().then((data) => res.json(JSON.stringify({id:data.id,price:data.price,title:data.title,img:data.url,nombre:"Ariel Rubel"})))
