...
app.get("/productoRandom", (req, res) => myInstance.getById(-1).then((data)=>res.render('card',{id:data.id,price:data.price,title:data.title,img:data.url,nombre:'Ariel Rubel'})))
